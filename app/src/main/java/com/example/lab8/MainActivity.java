    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MainActivity.this, "yappy Successful Add", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.show();
                Toast.makeText(MainActivity.this,"hahahha Successful View",Toast.LENGTH_LONG).show();
            }
        });
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MainActivity.this,"hahahah Successful Delete",Toast.LENGTH_LONG).show();
            }
        });
    }
}